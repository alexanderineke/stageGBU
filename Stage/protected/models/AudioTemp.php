 ...
 *
 * The followings are the available columns in table '{{audio_temp}}':
 * @property string $id
 ...
 */
class AudioTemp extends CActiveRecord
{
    /**
    ...
    public function addTempFile($filename, $location){
        $sql = "insert into tbl_audio_temp (user_id, create_date, file, format, location) values (:user_id, NOW(), :file, :format, :location)";
     ...
     * @return AudioTemp the static model class
     */
