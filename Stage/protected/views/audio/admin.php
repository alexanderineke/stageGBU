...
$this->menu=array(
    ...
    array('label'=>'Lijst van audio','icon'=>'list','url'=>array('index'),'visible'=>Yii::app()->user->checkAccess('moderator')),
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'columns'=> array(  
        array(  'name'=>'title',
                'filter'=>CHtml::activeTextField($model, 'title', array('placeholder'=>'Zoek op titel..'))
        ),
