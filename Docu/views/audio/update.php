...
echo Menu::widget([
    'items' => [
        ...
        ['label' => 'Lijst van audio bestanden', 'url' => ['index'], 'icon' => 'list', 'visible' => !Yii::$app->user->isGuest], //Yii::$app->user->getIdentity('moderator')],
        ['label' => 'Maak audio bestanden aan', 'url' => ['create'], 'icon' => 'file', 'visible' => !Yii::$app->user->isGuest], //Yii::$app->user->getIdentity('user')],
        ['label' => 'Bekijk audio bestand', 'url' => ['view', 'id' => $model->id], 'icon' => 'eye-open', 'visible' => !Yii::$app->user->isGuest], //Yii::$app->user->getIdentity('moderator')],
